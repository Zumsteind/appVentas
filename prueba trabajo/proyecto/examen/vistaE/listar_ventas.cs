...
namespace vistaE
{
    public partial class listar_ventas : Form
    {
        ...
        {
            if (dgvventas.CurrentRow != null && dgvventas.CurrentRow.Cells[0].Value != null)
            {
        ...
        private void txtbuscarcliente_TextChanged(object sender, EventArgs e)
        {
            ...
            NegocioVentas negocio = new NegocioVentas();
            List<Ventas> listaVentas = negocio.BuscarVentasPorNombreCliente(txtbuscarcliente.Text);
